...
public class BlogController {
    ...
    public Result saveBlog(@RequestBody Blog blog) {
        blogService.saveAndFeedBlog(blog);
    ...
    @GetMapping("/likes/{id}")
    public Result queryBlogLikesUser(@PathVariable("id") Long id){
        List<UserDTO> top5UserList = blogService.queryLikesUser(id);
